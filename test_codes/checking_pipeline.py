...
def call_gpt4o_judge(product_info: dict, requirements: dict) -> str:
    ...
    system_prompt = "너는 IT 프로덕트 전문가로서, 제품이 주어진 요구 조건을 만족하는지 평가하는 역할을 수행해."
    user_prompt_t = Template("""
다음은 제품 요구 조건과 제품 정보입니다.
...
이 제품이 요구 조건을 전반적으로 만족하면 'YES'만 출력하고, 만족하지 않으면 'NO'만 출력해주세요. 이유는 출력하지 마세요.
""")
